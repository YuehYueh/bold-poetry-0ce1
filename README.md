...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/bold-poetry-0ce1#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/bold-poetry-0ce1
```

A live public deployment of this template is available at [https://bold-poetry-0ce1.templates.workers.dev](https://bold-poetry-0ce1.templates.workers.dev)
